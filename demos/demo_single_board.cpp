...
{  
    ...
    auto motor_1 = std::make_shared<blmc_drivers::Motor>(board1, 0);
    auto motor_2 = std::make_shared<blmc_drivers::Motor>(board1, 1);
    auto motor_3 = std::make_shared<blmc_drivers::Motor>(board2, 0);
    auto motor_4 = std::make_shared<blmc_drivers::Motor>(board2, 1);

    auto motor_5 = std::make_shared<blmc_drivers::Motor>(board3, 0);
    ...
    Controller controller5(motor_5, analog_sensor_3);
